...
fileID = fopen('line1DE_final.dir');
Vp = fread(fileID, [80 701], 'float');
fclose(fileID);
dx = 0.0375; %x-spacing in km
dy = 0.0375; %z-spacing in km
datum = 3.4; %Water depth at top in km
cutoff_vel = 3.4; %Sediment-crust cutoff velocity
